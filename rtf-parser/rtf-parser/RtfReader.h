...
namespace RtfReader
{
	RTFREADER_EXT bool RtfStream2HtmlString(std::string &outstring, std::istream &instream);
	RTFREADER_EXT bool RtfString2HtmlString(std::string &outstring, const std::string &instring);
	RTFREADER_EXT bool RtfFile2HtmlString(std::string &outstring, const char *filename);
